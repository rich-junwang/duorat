(import 'duorat-finetune-bert-large.jsonnet') {
    ...
    data: [
        ...
        {
            name: 'Spider_by_synthetic_data_v5_by_gold_template_scfg_alls',
            train: (import '../../data/train_with_synthetic_data_v5_by_gold_template_scfg_alls.libsonnet')(prefix=PREFIX),
            type: 'synthetic'
        },
    ],
