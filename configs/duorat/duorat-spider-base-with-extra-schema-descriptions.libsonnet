function(output_from, data_path='data/', save_dir='duorat/') {
    ...
    data: {
        train: (import '../../data/train_spider_extra_schema_descriptions.libsonnet')(prefix=PREFIX),
        val: (import '../../data/val_spider_extra_schema_descriptions.libsonnet')(prefix=PREFIX),
    },
