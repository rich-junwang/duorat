...
def process_spider(spider_path, duorat_path) -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--dataset", type=str, default='spider', choices=["spider", "squall", "spider_aug"])
    ...
    if args.dataset == "spider":
        process_spider(args.spider_path, args.duorat_path)
    elif args.dataset == "squall":
        process_squall(args.spider_path, args.duorat_path)
    else:
